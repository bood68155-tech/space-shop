...
export default function ProductCard({ name, price, image_url, category, index = 0 }: ProductCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl transition-colors duration-300 hover:border-white/20 hover:bg-white/10"
      style={{
        boxShadow: hovered
          ? "0 20px 60px rgba(255, 255, 255, 0.05), 0 8px 24px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255,255,255,0.08)"
